        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <asp:SqlDataSource ID="sdsList" runat="server" ConnectionString="<%$ ConnectionStrings:CEBR_projectsDatabaseConnectionString %>" SelectCommand="SELECT * FROM [URCD_UniversityProjects].[WWU\swanso31].[tblWWUEntity]"></asp:SqlDataSource>
                    <asp:SqlDataSource ID="sdsDetail" runat="server" ConnectionString="<%$ ConnectionStrings:CEBR_projectsDatabaseConnectionString %>" SelectCommand="SELECT * FROM [URCD_UniversityProjects].[WWU\swanso31].[tblWWUEntity] WHERE ([WWUEntityID] = @WWUEntityID)" DeleteCommand="DELETE FROM [URCD_UniversityProjects].[WWU\swanso31].[tblWWUEntity] WHERE [WWUEntityID] = @WWUEntityID" InsertCommand="INSERT INTO [URCD_UniversityProjects].[WWU\swanso31].[tblWWUEntity] ([EntityName], [EntityPurpose], [ContactPerson], [ActivityType], [ClientIsInternalWWU], [ClientIsForProfit], [ClientIsNonProfit], [ClientIsGovernment], [ClientIsTribal], [EngagementIsProject], [EngagementIsQuarter], [EngagementIsContract]) VALUES (@EntityName, @EntityPurpose, @ContactPerson, @ActivityType, @ClientIsInternalWWU, @ClientIsForProfit, @ClientIsNonProfit, @ClientIsGovernment, @ClientIsTribal, @EngagementIsProject, @EngagementIsQuarter, @EngagementIsContract)" UpdateCommand="UPDATE [URCD_UniversityProjects].[WWU\swanso31].[tblWWUEntity] SET [EntityName] = @EntityName, [EntityPurpose] = @EntityPurpose, [ContactPerson] = @ContactPerson, [ActivityType] = @ActivityType, [ClientIsInternalWWU] = @ClientIsInternalWWU, [ClientIsForProfit] = @ClientIsForProfit, [ClientIsNonProfit] = @ClientIsNonProfit, [ClientIsGovernment] = @ClientIsGovernment, [ClientIsTribal] = @ClientIsTribal, [EngagementIsProject] = @EngagementIsProject, [EngagementIsQuarter] = @EngagementIsQuarter, [EngagementIsContract] = @EngagementIsContract WHERE [WWUEntityID] = @WWUEntityID">
                        <DeleteParameters>
